...
(0, _utils.preloadImages)(".slides__img-inner").then(()=>document.body.classList.remove("loading"));

},{"./utils":"72Dku","./slideshow":"ao8JN","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72Dku":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Slideshow {
    ...
    constructor(DOM_el, options = {}){
        ...
        this.DOM.slides.forEach((slideEl)=>this.slidesArr.push(new (0, _slide.Slide)(slideEl)));
     ...
     */ navigate(position = this.current) {
        ...
        }).addLabel("start", 0)// Upcoming Slide gets shown behind the current Slide animates out
        .set(this.upcomingSlide.DOM.outer, {
            opacity: 1
        }, "start")// outer/inner opposite translations (Reveal effect)
        .to(this.currentSlide.DOM.outer, {
            x: this.direction === "next" ? "-101%" : "101%",
            onComplete: ()=>(0, _gsap.gsap).set(this.currentSlide.DOM.outer, {
                    x: "0%",
                    opacity: 0
                })
        }, "start").to(this.currentSlide.DOM.inner, {
            x: this.direction === "next" ? "101%" : "-101%",
            onComplete: ()=>(0, _gsap.gsap).set(this.currentSlide.DOM.inner, {
                    x: "0%"
                })
        }, "start");
        // Filters animation
        if (this.filtersAnimation) this.timeline.to(this.currentSlide.DOM.inner, {
            startAt: {
        ...
        }, "start").to(this.upcomingSlide.DOM.inner, {
            startAt: {
                filter: "brightness(800%)"
            },
            filter: "brightness(100%)"
...
},{"./slide":"a2l79","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a2l79":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/** 
...
},{"gsap/gsap-core":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"05eeC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","./CSSPlugin.js":"l02JQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l02JQ":[function(require,module,exports) {
/*!
 * CSSPlugin 3.12.2
 * https://greensock.com
 *
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["b3anl","ebWYT"], "ebWYT", "parcelRequire01ee")

//# sourceMappingURL=fords.739bf03c.js.map
